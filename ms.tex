...
After the reference spectrum is used to find a wavelength solution, the spectrum is examined some strong stellar lines, including the Na D$_1$/D$_2$ lines (Figure \ref{fig:naDlines} and the Mg Triplet (Figure \ref{fig:mgTriplet}).
The Mg triplet is diagnostic of spectral type and may help resolve some of the conflicts in the literature about the gravity of the host star.
...
First, the points above 2.0 are flagged as bad pixels and interpolated over.
Second, a convolution kernel is applied and the spectrum is compared to HIGHRES models.}\label{fig:mgTriplet}
\end{centering}
\end{figure}
