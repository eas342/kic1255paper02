...
We also evaluate high resolution archival spectra from the Subaru HDS spectrograph and find them to be consistent with a main-sequence T$_{eff}$=4500 $\pm$110 K star in agreement with the photometry and low resolution spectroscopy.
...
KIC 12557548's light curve exhibits flux dips with a period of 0.653 days.
...
The time variability of the flux dips indicates that material with a projected area $\sim$1\% of the stellar surface is created and cleared in $\lesssim$ 1 day timescales in order to extinct $\sim$1.2\% of starlight at one epoch and $\sim$0\% at another.
...
We confirm the result of \citet{vanWerkhoven2014} that no secondary eclipse is detected at f$_p$/f$_*$ $\lesssim 50$~ppm, seen in Figure \ref{fig:secEclipse}, where f$_p$/f$_*$ is the relative flux of the planet to star in the Kepler bandpass.
...
(Right) The residuals show significant deviations near phases of -0.05 and 0.05.
