...
This was \replaced{smaller}{broader} than we expected from combining inverse resolving powers in quadrature, which would imply that an $R=75,000 $ kernel \added{$\sigma_\mathrm{expected} = 1/176,610$} convolved with an $R=100,000$ spectrum would result in a $R=60,000$ spectrum.
\added{This is likely because of the non-Gaussian nature of the Subaru line spread function.}
