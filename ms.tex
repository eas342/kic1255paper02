...
The 2013 data was taken with an image slicer and a wider ((2 $\times$ 30 mm)) slit, which create 3 parallel traces for \shStar.
...
\caption{Example spectrum of \shStar\ (reduced by Kento Mashuda) near the Mg triplet compared to 4500 K BOSZ models with two different log(g)s.}\label{fig:mgTriplet}
\end{centering}
\end{figure}
