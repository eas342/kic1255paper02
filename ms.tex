...
2013-08-13 & 2013-09-03 & IRTF & $g'$, NIR spectroscopy & \citet{schlawin2016kic1255} \\
2014-08-14 & 2013-09-04 & IRTF & $g'$, NIR spectroscopy & \citet{schlawin2016kic1255} \\
\enddata
...
When using a wider aperture (9 pixels), the photometric stability is much improved and the 0.5\% transit depth is readily visible in Figure \ref{}.
The Kepler-based ephemeris indicates a transit at JD = 2457551.830.

\begin{figure}
\begin{centering}
\includegraphics[width=0.5\textwidth]{images/refcor_01.pdf}
\caption{Reference-corrected photometry for \shStar\ near the transit at JD = 2457551.830.}\label{fig:refCorrectedPhotAug12}
\end{centering}
\end{figure}
