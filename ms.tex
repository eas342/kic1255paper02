...
There is a tentative 491 day periodicity of the second principal component, which corresponds to possible long-term evolution of the dust grain sizes, though the mechanism is unclear.
\end{abstract}
...
The residuals (Right) have $\lesssim 0.1\%$ residuals in contrast to the average-light curve method used in Figure \ref{fig:riverPlots}.
...
\citet{schlawin2016kic1255} found shallow transits (all below the Kepler observatory average) in August-September 2013 and August-September 2014.
