...
\added{Similarly, a new system (KIC 3542116) has been discovered that has a light curve explained by extrasolar comets that produce transits in the broadband optical  \citep{rappaport2018exocomets}.}
...
The peaks at 0.654 days in both the first and second principal components are the same as the orbital period, which determines the sampling cadence of the time series of amplitudes and principal components.
