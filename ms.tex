...
The residual is shown with a different scaling below.
In this fitting process, no adjustments were made for timing, which is apparent in the residuals.}\label{fig:kepPCA}
\end{centering}
\end{figure*}
