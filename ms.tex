...
\subsection{BOSZ Model Exploration}

We also convolve the data with a R=40,000 kernel so that we could compare the data to the BOSZ models.
Then, we explore the 5 parameters in the BOSZ models: T$_{eff}$, log(g), [M/H], [$\alpha$/M] and [C/M].
