...
The amplitude is found with a dot product with the average light curve for the Kepler data (left 3 panels) and with a scaled model for the ground-based data (right plot).
...
This singly-peaked periodogram (other than the 0.654 day sampling period) implies that PC$_2$ is nearly sinusoidal.
...
Future high resolution spectroscopy at an orbital phase of 0.0 may be useful for searching for gaseous planetary debris.
