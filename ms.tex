...
The disintegrating planet candidate KIC 12557548 b (hereafter \sha) \citep{rappaport} was the first discovery of a planet candidate causes stochastically varying dust obscuration of its host star.
It is now one of many systems that have stochastically varying transit depths.
The discovery of K2-22b \citep{sanchis-ojedak2-22}, WD 1145+017 \citep{vanderburg2015wdDisintegrating}, KOI 2700 \citep{rappaport2014KOI2700} showed that other systems have similar light curves and can have wavelength-dependent transmission predicted for dust particles \citep{bochinski2015evolving,sanchis-ojedak2-22}.
