...
There is a tentative 491 day periodicity of the second principal component, which corresponds to possible long-term evolution of the dust grain sizes.
\end{abstract}
...
We highlight the quiescent periods also discussed in \citet{kawahara2013starspots}, \citet{vanWerkhoven2014} and \citet{croll2015starspots}.
...
The peaks at 0.654 days in both the first and second principal components are the same as the orbital period and are the same as the sampling interval of the time series.
...
The first peak at 0.654 days for both principal components is the orbital period, which is the sampling time for these time series.
The PC$_1$ also peaks at 153 and 750 days, likely because of the intervals of low disintegration activity.
...
The second principal components shows one dominant peak at 491 days, in addition to the 0.654 orbital period.}\label{fig:ampPeriodogram}
\end{centering}
\end{figure*}
...
We calculate and evalute the Kepler transit amplitudes to better understand the long-term behavior of \sha's disintegration.
...
The histogram of secondary eclipse amplitudes from the Kepler light curves is also shown in \ref{fig:histoPhot}.
...
A Kolmogorov-Smirnov test gives a p value of 0.001 of the null hypothesis that the \citet{schlawin2016kic1255} results are drawn from the same distribution as the Kepler Long Cadence data.
...
The \citet{schlawin2016kic1255} (S16) events give a KS-test p value of 0.001 of the null hypothesis when comparing to the Kepler data.
In contrast, the 2016 photometric results in this work are consistent with the Kepler Long Cadence data, giving a  p value of 0.5 of the null hypothesis.
