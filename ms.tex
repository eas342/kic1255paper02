...
High resolution spectra, however, indicate a higher temperature 4900 K lower log(g) sub-giant star \citep{kawahara}
We decided to re-visit the high resolution spectrum from \citet{kawahara} by downloading the raw data from the Subaru SMOKA database.
