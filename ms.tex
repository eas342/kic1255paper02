...
The residual of this model shows substantial deviations from white noise, so we explore more sophisticated models than the average light curve.
...
We start by rescaling the two dimensional grid to have zero mean and a variance of 1.0 along the Transit Number axis.
