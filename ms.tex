...
\caption{Spectra images from 2013 versus 2015. The PSF profile (bottom panel) is much larger in 2013 is more difficult to fit with a tracing function.}\label{fig:prof2013vs2015}
\end{centering}
\end{figure}
...
The wider longer slit (2 $\times$ 30 mm) used in 2013 versus the narrower one in 2015 (0.3 $\times$ 3.5 mm) produce very different PSFs.
