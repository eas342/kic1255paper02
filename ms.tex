...
For the eigenvectors plot, we multiply each eigenvector by the square root of the explained variance of each principal component, as is used in meteorology \citep{richman1986pcaRotation}.
