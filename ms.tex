...
While examining the bolometric flux from all available data, we notice that the WISE band 3 and 4 fluxes at 12 $\mu$m and 22 $\mu$m are significantly in excess of a \citet{castelli2004models} stellar model, as shown in Figure \ref{fig:SED}.
