...
After the reference spectrum is used to find a wavelength solution, the spectrum is examined some strong stellar lines, including the Na D$_1$/D$_2$ lines (Figure \ref{fig:naDlines}), the Mg Triplet (Figure \ref{fig:mgTriplet}) and the Ca I 6262 $\AA$ line (Figure \ref{fig:CaILine}).
