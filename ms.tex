...
When using a wider aperture (9 pixels), the photometric stability is much improved and the 0.5\% transit depth is readily visible in Figure \ref{fig:refCorrectedPhotAug12}.
The Kepler-based ephemeris indicates a transit at JD = 2457551.830.

\begin{figure}
\begin{centering}
\includegraphics[width=0.5\textwidth]{images/refcor_01.pdf}
\caption{Reference-corrected photometry for \shStar\ near the transit at JD = 2457551.830 (UT 2016-06-12).}\label{fig:refCorrectedPhotAug12}
\end{centering}
\end{figure}
...
\caption{Reference-corrected photometry for \shStar\ on UT 2016-06-14.}\label{fig:refCorrectedPhotAug12}
\end{centering}
\end{figure}
