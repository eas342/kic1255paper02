...
\added{Another area to be explored is the WISE band 3 and 4 infrared excess in the spectral energy distribution, probably arising for a dust ring or disk.}
\end{abstract}
...
We begin with 1 principal component and progressively added one at at time until the residuals along the transit number axis of Figure \ref{fig:riverPlotsPCA} are the same as the out-of-transit flux.
We find that after 4 eigenvectors, the in-transit (with phases between -0.12 and 0.15) matches the out-of-transit standard deviation of $\sim 0.05\%$.}
...
We suspect that sublimating asteroids around WD1145+017, the \sha\ and K2-22 b have long term behavior determined by surface features.
...
These infrared fluxes may arise from dust created by the disintegrating planet and radiatively pushed out to a larger radius to form a disk or ring.
